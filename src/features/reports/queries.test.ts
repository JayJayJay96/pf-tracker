...
describe('getReport', () => {
  ...
  it('calculates plan, shared-bill, and settlement metrics without treating collection as income', async () => {
    const report = await getReport(
      repository({
        listPlanEntries: [
          { id: 'salary', entry_date: '2026-07-01', name: 'Salary', entry_type: 'income', amount_sen: 500000, status: 'confirmed' },
          { id: 'kpi', entry_date: '2026-07-02', name: 'Estimated KPI', entry_type: 'income', amount_sen: 10000, status: 'pending' },
          { id: 'rent', entry_date: '2026-07-03', name: 'Rent', entry_type: 'commitment', amount_sen: 120000, status: 'active' },
